...
MySQL - 5.7.36 : Database - tg_nacos
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`tg_nacos` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='config_info';
...
CREATE TABLE `his_config_info` (
  ...
  KEY `idx_did` (`data_id`)
) ENGINE=InnoDB AUTO_INCREMENT=104 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='多租户改造';
